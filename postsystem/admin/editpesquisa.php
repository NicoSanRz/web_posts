...
$id = $_GET['id'];
$select = "SELECT * from tb_pesquisas WHERE id=:id";
$contagem =1;
		...
		if($numFile <= 0){
			...
			$update = "UPDATE tb_pesquisas SET titulo=:titulo, imagem=:imagem, descricao=:descricao WHERE id=:id";
								...
								<form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">											
											...
											<div class="controls">
                                                ...
                                                <img src="../upload/pesquisas/<?php echo $novoNome;?>" width="50"/>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
