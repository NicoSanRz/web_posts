    ...
    <div class="container">
     <div class="row">
		...
		if($numFile <= 0){
			...
			$insert = "INSERT into tb_cursos (titulo, imagem, descricao) VALUES (:titulo, :imagem, :descricao)";
                        ...
                        <div class="tab-pane" id="formcontrols">
								<form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span8" name="descricao" id="descricao" value="" rows="10"></textarea>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
