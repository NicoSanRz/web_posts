            ...
            <div class="span12">	      		
                ...
                <div class="widget-header">
	      			...
	      			<div class="widget-content">	      				
                        ...
                        <?php
//RECUPERA OS DADOS
if(!isset($_GET['id'])){ header("Location: home.php?acao=ver-coberturas"); exit;}
$id = $_GET['id'];
$select = "SELECT * from tb_coberturas WHERE id=:id";
$contagem =1;
		...
		// ATUALIZAR				
	  	if(isset($_POST['atualizar'])){
			...
			$update = "UPDATE tb_coberturas SET titulo=:titulo, descricao=:descricao WHERE id=:id";
