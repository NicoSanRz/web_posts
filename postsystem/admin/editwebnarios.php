...
$id = $_GET['id'];
$select = "SELECT * from tb_webnarios WHERE id=:id";
$contagem =1;
		...
		if($numFile <= 0){
			...
			$update = "UPDATE tb_webnarios SET titulo=:titulo, imagem=:imagem, descricao=:descricao WHERE id=:id";
								...
								<form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">											
											...
											<div class="controls">
                                                ...
                                                <img src="../upload/webnarios/<?php echo $novoNome;?>" width="50"/>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
