     ...
     <div class="row">
            ...
            <div class="span12">	      		
                ...
                <div class="widget-header">
	      				<i class="icon-file"></i>
	      				<h3>Editar Portarias e Legislações</h3>
	  				</div> <!-- /widget-header -->
	      			...
	      			<div class="widget-content">	      				
                        ...
                        <?php
//RECUPERA OS DADOS
if(!isset($_GET['id'])){ header("Location: home.php?acao=ver-port"); exit;}
$id = $_GET['id'];
$select = "SELECT * from tb_portarias WHERE id=:id";
$contagem =1;
		...
		// ATUALIZAR				
	  	if(isset($_POST['atualizar'])){
			...
			$update = "UPDATE tb_portarias SET titulo=:titulo, descricao=:descricao WHERE id=:id";
