...
$id = $_GET['id'];
$select = "SELECT * from tb_cursos WHERE id=:id";
$contagem =1;
		...
		if($numFile <= 0){
			...
			$update = "UPDATE tb_cursos SET titulo=:titulo, imagem=:imagem, descricao=:descricao WHERE id=:id";
								...
								<form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">											
											...
											<div class="controls">
                                                ...
                                                <img src="../upload/cursos/<?php echo $novoNome;?>" width="50"/>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span8" name="descricao" id="descricao" value="" rows="10"><?php echo $descricao;?>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
