...
-->
  ...
  <body>
    ...
    <?php 
           ...
           $sql = "SELECT * from tb_cursos ORDER BY id DESC LIMIT $inicio, $quantidade";
           try{
        ...
        <div class= "row justify-content-center">
          <div class="card" style="width: 18rem;">
              <img class="card-img-top" src="postsystem/upload/cursos/<?php echo $exibe->imagem;?>" alt="<?php echo $exibe->titulo;?>" title="<?php echo $exibe->titulo;?>" alt="Card image cap">
              <div class="card-body">
                <h3 class="card-title"><?php echo $exibe->titulo;?></h3>
                <br>
                <a href="<?php echo $exibe->descricao;?>" class="btn text-white" style="background-color: #8D38D0;">Clique aqui para abrir</a>
                <br><br>
              </div>
          </div>
          <br><br>
    ...
    <?php
        ...
        ?>
        <div class="paginas">
          <a href="cursos.php?pg=1">Primeira Página</a>
          <?php 
             if(isset($_GET['pg'])){
              $num_pg = $_GET['pg'];	
            }
          ...
          ?>
          <a href="cursos.php?pg=<?php echo $i;?>"  class="ativo<?php echo $i;?>"><?php echo $i;?></a>
  <?php  }} ?>
          <a href="cursos.php?pg=<?php echo $pg;?>" class="ativo<?php echo $i;?>"><?php echo $pg;?></a>
          <?php
          ...
          ?>
          <a href="cursos.php?pg=<?php echo $paginas;?>">Última página</a>
        </div>
