...
<?php
	...
	$sql = "SELECT * from tb_pesquisas WHERE id=:id LIMIT 1";
	try{
...
?>        
			...
			<li>            	
                <span class="thumb">
                	<img src="postsystem/upload/pesquisas/<?php echo $exibe->imagem;?>" alt="<?php echo $exibe->titulo;?>" title="<?php echo $exibe->titulo;?>" width="166" height="166">
                </span>                
                <span class="content">
